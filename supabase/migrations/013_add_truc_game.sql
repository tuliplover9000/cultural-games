-- Migration 013: Add truc (Truc) to valid games
-- Recreates record_game_result with 'truc' added to the whitelist so that
-- signed-in players' Truc wins/losses persist stats and award coins server-side.
