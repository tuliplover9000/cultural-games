...
(function () {
  ...
  var GAMES = [
    ...
    { key: 'senet',       name: 'Senet',              culture: 'Ancient Egypt',        type: 'Board',    icon: '🏺', svg: '../assets/icons/senet.svg',      badge: 'Board · 2P',   maxPlayers: 2,
      rules: ['Throw four sticks to move your five pieces along the 30-square path to the afterlife.', 'Land on a lone enemy piece to swap places with it. Pairs are safe; three in a row block the path.', 'Navigate the special houses — Beauty, Water, the Three Truths — and bear all five pieces off first to win.'] },
    { key: 'truc',        name: 'Truc',               culture: 'Catalonia',            type: 'Card',     icon: '🃏', svg: '../assets/icons/truc.svg',       badge: 'Card · 2P',    maxPlayers: 2,
      rules: ['Three cards each, three tricks — no trumps and no following suit. Ranking: 3, 2, ace, king, knight, knave, 7, 6, 5, 4.', 'Call "Truc!" to raise the hand from 1 point to 2, "Retruc!" to 3. Decline a raise and your opponent scores the lower stake.', 'Win two of three tricks (the first trick breaks ties). First player to 12 points wins.'] },
