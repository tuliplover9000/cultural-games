...
(function () {
  ...
  var ACHIEVEMENTS = [
    ...
    { id: 'sc_first_win',  gameId: 'scopa',         title: 'Prima Presa',       description: 'Win your first game of Scopa',                          tier: 'bronze', category: 'combat', condition: { type: 'stat',   game: 'scopa',    stat: 'wins', threshold: 1  } },
    { id: 'sc_wins_10',    gameId: 'scopa',         title: 'Asso di Denari',    description: 'Win 10 games of Scopa',                                 tier: 'silver', category: 'combat', condition: { type: 'stat',   game: 'scopa',    stat: 'wins', threshold: 10 } },
    { id: 'sc_wins_50',    gameId: 'scopa',         title: 'Re di Bastoni',     description: 'Win 50 games of Scopa',                                 tier: 'gold',   category: 'combat', condition: { type: 'stat',   game: 'scopa',    stat: 'wins', threshold: 50 } },
    { id: 'sc_scopa',      gameId: 'scopa',         title: 'Scopa!',            description: 'Sweep the table clean in a single capture',             tier: 'bronze', category: 'combat', condition: { type: 'action', action: 'sc_scopa'     } },
    { id: 'dk_first_win',  gameId: 'durak',         title: 'Not the Fool',      description: 'Win your first game of Durak',                          tier: 'bronze', category: 'combat', condition: { type: 'stat',   game: 'durak',    stat: 'wins', threshold: 1  } },
    { id: 'dk_wins_10',    gameId: 'durak',         title: 'Attacker',          description: 'Win 10 games of Durak',                                 tier: 'silver', category: 'combat', condition: { type: 'stat',   game: 'durak',    stat: 'wins', threshold: 10 } },
    { id: 'dk_wins_50',    gameId: 'durak',         title: 'Podkidnoy Master',  description: 'Win 50 games of Durak',                                 tier: 'gold',   category: 'combat', condition: { type: 'stat',   game: 'durak',    stat: 'wins', threshold: 50 } },
    { id: 'yn_first_win',  gameId: 'yut-nori',      title: '첫 승리',           description: 'Win your first game of Yut Nori',                       tier: 'bronze', category: 'combat', condition: { type: 'stat',   game: 'yut-nori', stat: 'wins', threshold: 1  } },
    { id: 'yn_wins_10',    gameId: 'yut-nori',      title: '윷 명인',           description: 'Win 10 games of Yut Nori',                              tier: 'silver', category: 'combat', condition: { type: 'stat',   game: 'yut-nori', stat: 'wins', threshold: 10 } },
    ...
    { id: 'tu_first_win',  gameId: 'truc',          title: 'Primera Cama',      description: 'Win your first game of Truc',                           tier: 'bronze', category: 'combat', condition: { type: 'stat',   game: 'truc', stat: 'wins', threshold: 1  } },
    { id: 'tu_wins_10',    gameId: 'truc',          title: 'Trucador de Barri', description: 'Win 10 games of Truc',                                  tier: 'silver', category: 'combat', condition: { type: 'stat',   game: 'truc', stat: 'wins', threshold: 10 } },
    { id: 'tu_wins_50',    gameId: 'truc',          title: 'Campió de Penya',   description: 'Win 50 games of Truc',                                  tier: 'gold',   category: 'combat', condition: { type: 'stat',   game: 'truc', stat: 'wins', threshold: 50 } },
    { id: 'tu_fold_steal', gameId: 'truc',          title: 'Cara de Pedra',     description: 'Make your opponent fold to your Truc call',             tier: 'bronze', category: 'combat', condition: { type: 'action', action: 'tu_fold_steal'  } },
    { id: 'tu_retruc_win', gameId: 'truc',          title: 'Retruc!',           description: 'Win a played-out hand at the full Retruc stake of 3',   tier: 'silver', category: 'combat', condition: { type: 'action', action: 'tu_retruc_win'  } },
    { id: 'tu_shutout',    gameId: 'truc',          title: 'Cama Seca',         description: 'Win a game of Truc 12–0',                               tier: 'gold',   category: 'combat', condition: { type: 'action', action: 'tu_shutout_win' } },
    ...
    { id: 'exp_play_all', gameId: null, title: 'World Game Master', description: 'Play every game on the site',          tier: 'gold',   category: 'explorer', condition: { type: 'games_played', threshold: 18 } },
    ...
    { id: 'exp_win_all',  gameId: null, title: 'Grand Tour',        description: 'Win at least one game of every title', tier: 'gold',   category: 'explorer', condition: { type: 'games_won', threshold: 18 } },
